...
const FashionShoppers = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center px-4 sm:px-6 lg:px-0 py-5 pop">
      <section className="bg-[#37474F66] text-white p-5 sm:p-12 rounded-3xl shadow-md w-full max-w-5xl">
          ...
          <div className="w-full md:w-2/3 space-y-4">
            ...
            <div className="flex justify-center md:justify-start">
              <button
               ...
               className="bg-white text-[#007AFF] px-5 py-2 rounded-md font-semibold text-sm hover:bg-opacity-90 transition">
                Get Early Access
              </button>
            </div>
          </div>
