...
const BrandForm = () => {
  ...
  const handleProductSelect = (e) => {
    ...
    setFormData((prev) => {
      const currentTypes = Array.isArray(prev.productTypes)
        ? prev.productTypes
        : [];
      return {
        ...prev,
  ...
  //   const scriptURL =
  //     "https://script.google.com/macros/s/AKfycbxVNFKpinhPIEnfnr4yXptbKp7GAQz0htb9a8x7CgUedbSZiQjvIa6yDfXSr864wiVM/exec";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://script.google.com/macros/s/AKfycbz2ExIT4GiAjPuHGISkuChQzo50ePQHp1vu6GWPWqUpZG-MkJOxktwNxQrYAoWJQZXLkg/exec",
        {
          method: "POST",
      ...
      console.error(err);
      alert("Error connecting to Google Sheets API");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 to-black text-gray-100 font-sans pop flex flex-col">
      <Navbar />
      <main className="flex-grow flex items-center justify-center pt-20 md:pt-36 px-4 pb-12">
        <div className="w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="lg:w-1/3 space-y-6">
              ...
              >
                Join SLAYYER's network of premium fashion brands and reach
                customers who demand instant delivery.
              </motion.p>
            </div>
          </motion.div>
        </div>
