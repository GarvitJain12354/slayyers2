  ...
  return (
    <div className="w-full flex items-center justify-between absolute top-0 left-0 px-10">
      ...
      <div className="gradient-border">
        <div className="inner-box p-4 flex items-center justify-center gap-4 bg-black rounded-2xl z-50">
          ...
          <NavLink to="/contact" className="font-[#FFFFFF] text-base opacity-45">
            Contact Us
          </NavLink>
        </div>
      </div>
